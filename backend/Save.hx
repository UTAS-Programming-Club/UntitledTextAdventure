...
class SaveData {
  ...
  public var headIdx: Int = 0;            // 4 Bits, [00, 11]
  public var upperBodyIdx: Int = 0;       // 4 Bits, [12, 23]
  public var handsIdx: Int = 0;           // 4 Bits, [24, 35]
  public var lowerBodyIdx: Int = 0;       // 4 Bits, [36, 47]
  public var feetIdx: Int = 0;            // 4 Bits, [48, 59]
  public var primaryWeaponIdx: Int = 0;   // 4 Bits, [60, 75]
  public var secondaryWeaponIdx: Int = 0; // 4 Bits, [60, 75]
